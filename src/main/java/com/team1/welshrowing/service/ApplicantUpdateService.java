...
public class ApplicantUpdateService {
    ...
    public void updateByComments(String newComments, String oldComments, Long applicantID) {
        repository.ApplicantUpdateByStatus(newComments, oldComments, applicantID);
    }
