...
If you run the production server, please create a `WelshRowing` database first. You can optionally run the `security.sql` file from the `resources` folder to add DB security features for the Cyber Security module.
